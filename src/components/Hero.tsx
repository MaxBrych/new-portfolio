...
export default function Hero() {
  return (
    <motion.div className="col-span-4 row-span-2 p-4 bg-white cursor-default md:p-6 md:row-span-1 rounded-3xl md:col-span-6">
      ...
      />
      <h1 className="mb-1 text-2xl font-bold tracking-tight md:mb-2 md:text-4xl text-dark-30">
        Hi, ich bin Max!
      </h1>
      <p className="text-base font-medium leading-5 md:leading-7 text-dark-10 md:text-xl">
